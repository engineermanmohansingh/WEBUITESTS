...
public class PageLibrary extends seleniumCore {
    ...
    /*
     *Wrapper methods for Finding Elements on a specific page. 
     */
  ...
  public void hardAssert(String actualText,String ExpectedText){  
	  	Assert.assertEquals(actualText,ExpectedText);
	  	logMessage("✔ ASSERT PASSED: values matched");
	  }
